...
<body>
 ...
 <div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header"> Đơn đặt hàng của  <?php echo $_GET['name'];  ?> </h1>
      </div>
      ...
      <form action="savepurchase.php" method="post" class = "form-group">
        ...
        $today = date('Y-m-d');
        ?>
        <label>Ngày đặt : </label><input type="text"  style="width: 600px;" class = "form-control" name="date" value = "<?php echo $today; ?>" />

        <label>Nhà cung cấp : </label><input type = "text" style="width: 600px;" class = "form-control" name = "supplier" value = "<?php echo $_GET['name']; ?>">

        <label>Ngày giao : </label><input type="date" style="width: 600px;" class = "form-control" name="date_delivered" />
      ...
      <input type ="text" name = "status" value = "" class = "form-control" style="width: 600px;" >
      <br />
      <!-- <button onclick="myFunction()" class="btn btn-primary" type="submit">Print PO</button> -->
      <button class="btn btn-primary" type="submit">Thêm đơn đặt hàng </button>
    </form>
<div>
 <?php
    $id=$_GET['invoice'];
