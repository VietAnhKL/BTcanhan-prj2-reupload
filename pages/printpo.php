...
<div class ="container">
  ...
  ?>
  <h1>Đơn đặt hàng của <?php echo $supplier;  ?></h1>
  <div>
    <?php
    $id=$_GET['id'];
    include('connect.php');
    ...
    for($i=0; $rowaz = $resultaz->fetch(); $i++){
      echo 'Số hóa đơn :'.$rowaz['transaction_id'].'<br>';
      echo 'Mã đơn hàng : '.$rowaz['invoice_number'].'<br>';
      echo 'Ngày đặt hàng: '.$rowaz['date_order'].'<br>';
      echo 'Nhà cung cấp : '.$rowaz['suplier'].'<br>';
      echo 'Ngày giao hàng : '.$rowaz['date_deliver'].'<br>';
    }
    ?>
  </div>
